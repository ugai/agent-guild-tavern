...
Read the project source files. Range across each perspective — stop when you
have enough candidates. See [RECON.md](RECON.md) for what to look for in
...
Run **at most 4 web searches** for inspiration (comparable tools, framework
best practices, ecosystem patterns). Stop after 4 regardless of coverage.
