...
1. Identify the specific PR pair(s) that conflict.
2. Skip the conflicting PR and continue merging the remaining branches.
3. Report to the user which PRs conflicted and with which files.
4. Suggest running Raid Commander to re-analyze the conflicting PRs for a
