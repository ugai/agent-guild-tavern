...
`plugins/guild-tavern/skills/reading-guild-rules/SKILL.md` are codified in
...
triggered only when `plugins/guild-tavern/skills/*/SKILL.md` or `rubrics/` files change.
